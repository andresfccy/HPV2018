  ...
  *******************************************************************************/
  ...
  BEGIN
    ...
    IF listaCat.count > 0 THEN
      UPDATE T64_SISTEMATIZACION SET A64CATEGORIZADO = 1 WHERE A64CODIGO = p_idSistematizacion;
    ELSE
      UPDATE T64_SISTEMATIZACION SET A64CATEGORIZADO = 0 WHERE A64CODIGO = p_idSistematizacion;
    END IF;
