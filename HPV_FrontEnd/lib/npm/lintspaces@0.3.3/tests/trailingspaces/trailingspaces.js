...
exports.tests = {
  ...
  'should ignore trailingspaces inside comments when option is set': function(test) {
    ...
    expected = {};
    expected[file] = {
      '9': [merge({}, Messages.TRAILINGSPACES, {line: 9})],
      '11': [merge({}, Messages.TRAILINGSPACES, {line: 11})],
      '15': [merge({}, Messages.TRAILINGSPACES, {line: 15})],
      '17': [merge({}, Messages.TRAILINGSPACES, {line: 17})],
      '21': [merge({}, Messages.TRAILINGSPACES, {line: 21})],
      '26': [merge({}, Messages.TRAILINGSPACES, {line: 26})]
    };
