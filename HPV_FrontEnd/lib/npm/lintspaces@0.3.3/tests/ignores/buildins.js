...
exports.tests = {
  'should fail, when no ignore is set': function(test) {
    ...
    expected[file] = {
      ...
      '3': [merge({}, Messages.INDENTATION_TABS, {line: 3}), merge({}, Messages.TRAILINGSPACES, {line: 3})],
      '4': [merge({}, Messages.INDENTATION_TABS, {line: 4})],
      '10': [merge({}, Messages.INDENTATION_TABS, {line: 10})],
      '11': [merge({}, Messages.INDENTATION_TABS, {line: 11}), merge({}, Messages.TRAILINGSPACES, {line: 11})],
      ...
      '19': [merge({}, Messages.INDENTATION_TABS, {line: 19}), merge({}, Messages.TRAILINGSPACES, {line: 19})],
      '20': [merge({}, Messages.INDENTATION_TABS, {line: 20})],
      '27': [merge({}, Messages.INDENTATION_TABS, {line: 27})],
      '28': [merge({}, Messages.INDENTATION_TABS, {line: 28}), merge({}, Messages.TRAILINGSPACES, {line: 28})],
