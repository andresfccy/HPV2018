...
module.exports = {
  ...
  INDENTATION_GUESS: {
    type: types.HINT,
    code: 'NEWLINE_GUESS',
    message: 'The indentation in this line seems to be incorrect. ' + 'The expected indention is {a}, but {b} was found.'
  },
  TRAILINGSPACES: {
    code: 'TRAILINGSPACES',
    type: types.WARNING,
  ...
  EDITORCONFIG_NOTFOUND: {message: 'The config file "{a}" wasn\'t found.'},
  PATH_INVALID: {message: '"{a}" does not exists.'},
  PATH_ISNT_FILE: {message: '"{a}" is not a file.'}
};
