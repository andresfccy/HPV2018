...
annotatorPass.prereqs = ['angular:annotator:mark'];
annotatorPass.when(require('../signatures/simple')).do(function(chunk, info) {
  var type;
  if (chunk.callee && chunk.callee.property && chunk.callee.property.name) {
