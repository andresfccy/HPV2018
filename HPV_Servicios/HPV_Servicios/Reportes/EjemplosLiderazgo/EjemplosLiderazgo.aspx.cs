...
namespace HPV_Servicios.Reportes.EjemplosLiderazgo
{
    public partial class EjemplosLiderazgo : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                String rutaPlantilla = String.Format("{0}/ejemplosLiderazgo.xlsx", pathPlantilla);
                String rutaRpt = String.Format("{0}/ejemplosLiderazgo.xlsx", pathTmp);

                ManejadorExcel rpt = new ManejadorExcel();

                rpt.Abrir(rutaPlantilla);

                OE_RptEjemplosLiderazgo oe = new OE_RptEjemplosLiderazgo();
                ...
                OS_RptEjemplosLiderazgo os = new FachadaReporte().RptEjemplosLiderazgo(oe);
                ...
                if (os.Respuesta.Codigo == 0)
                {
                    ...
                    foreach (HPV_Entidades.Reporte.EjemplosLiderazgo reg in os.ListaEjemplosLiderazgo)
                    {
                        Int32 colum = 2;
                        var i = 0;
                        if (primeraFila)
