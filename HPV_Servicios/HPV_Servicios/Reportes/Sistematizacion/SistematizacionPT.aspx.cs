...
{
    public partial class SistematizacionPT : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                String rutaPlantilla = String.Format("{0}/sistematizacionPT.xlsx", pathPlantilla);
                String rutaRpt = String.Format("{0}/sistematizacionPT.xlsx", pathTmp);
                ...
                // Se parametriza el instrumento 3 como propuestas de transformación
                oe.ParametroRpt.IdTipoInstrumento = 3;
                ...
                if (os.ListaSistematizacion.Count > 0)
                    Response.AddHeader("Content-Disposition", "attachment;filename=SistPropTransf-p" + os.ListaSistematizacion[0].Atributos[1] + "-" + os.ListaSistematizacion[0].Atributos[os.ListaSistematizacion[0].Atributos.Count - 1] + ".xlsx");
                else
                    Response.AddHeader("Content-Disposition", "attachment;filename=SistPropTransf-p" + idPeriodo + "-" + FechaCorte + ".xlsx");
