...
{
    public partial class SistematizacionEL : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                String rutaPlantilla = String.Format("{0}/sistematizacionEL.xlsx", pathPlantilla);
                String rutaRpt = String.Format("{0}/sistematizacionEL.xlsx", pathTmp);
                ...
                // Se parametriza el instrumento 2 como Ejemplos de liderazgo
                oe.ParametroRpt.IdTipoInstrumento = 2;
                ...
                if (os.ListaSistematizacion.Count > 0)
                    Response.AddHeader("Content-Disposition", "attachment;filename=SistEjemplLid-p" + os.ListaSistematizacion[0].Atributos[1] + "-" + os.ListaSistematizacion[0].Atributos[os.ListaSistematizacion[0].Atributos.Count - 1] + ".xlsx");
                else
                    Response.AddHeader("Content-Disposition", "attachment;filename=SistEjemplLid-p" + idPeriodo + "-" + FechaCorte + ".xlsx");
